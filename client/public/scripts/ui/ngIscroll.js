...
.directive('ngIscroll', [
  '$rootScope',
  'ngIscroll.IS_MOBILE_DEVICE',
  '$iscroll',
  function($rootScope, IS_MOBILE_DEVICE, $iscroll) {
    return {
      replace: false,
      restrict: 'A',
      scope: {
